...
export function Features() {
    return (
        <section className="relative z-10 py-16 md:py-32 font-light">
            <div className="mx-auto max-w-6xl px-6">
                <div className="text-center mb-16">
                    <h2 className="text-3xl font-light text-white mb-4">Protocol Infrastructure</h2>
                    <p className="text-white/60 max-w-xl mx-auto text-lg">Built on the core principles of decentralization and cryptographic proof.</p>
                </div>

                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6 auto-rows-auto md:auto-rows-[250px]">

                    <Card className="relative overflow-hidden border-white/10 bg-white/5 md:col-span-1 md:row-span-2 group min-h-[300px] md:min-h-0 hover:border-[#9b87f5]/30 hover:shadow-[0_0_20px_rgba(155,135,245,0.1)] transition-all duration-300">
                        ...
                        <CardContent className="p-6 md:p-8 h-full flex flex-col justify-center items-center text-center relative z-10">
                            ...
                            <h3 className="text-4xl font-light text-transparent bg-clip-text bg-gradient-to-b from-white to-white/60 mb-4">
                                Verify
                            </h3>
                    ...
                    <Card className="relative overflow-hidden border-white/10 bg-white/5 group min-h-[200px] hover:border-[#9b87f5]/30 hover:shadow-[0_0_20px_rgba(155,135,245,0.1)] transition-all duration-300">
                        <div className="absolute inset-0 bg-gradient-to-br from-purple-500/5 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
                        <CardContent className="p-6 md:p-8 h-full flex flex-col justify-center">
                            <h3 className="text-2xl font-light text-transparent bg-clip-text bg-gradient-to-br from-purple-400 to-pink-400 mb-2">
                                Treasury
                            </h3>
                    ...
                    <Card className="relative overflow-hidden border-white/10 bg-white/5 group min-h-[200px] hover:border-[#9b87f5]/30 hover:shadow-[0_0_20px_rgba(155,135,245,0.1)] transition-all duration-300">
                        ...
                        <CardContent className="p-6 md:p-8 h-full flex flex-col items-center justify-center text-center">
                            ...
                            <p className="text-white/60 text-sm max-w-[200px] font-light">
                    ...
                    <Card className="relative overflow-hidden border-white/10 bg-white/5 group min-h-[200px] hover:border-[#9b87f5]/30 hover:shadow-[0_0_20px_rgba(155,135,245,0.1)] transition-all duration-300">
                        ...
                        <CardContent className="p-6 md:p-8 h-full flex flex-col justify-center items-center text-center">
                            <h3 className="text-4xl font-light text-transparent bg-clip-text bg-gradient-to-br from-amber-200 via-yellow-400 to-yellow-600 mb-2">
                                100%
                            </h3>
                            <p className="text-white/60 text-sm font-light">
                                On-Chain Governance
